...
RUN apk --update --no-cache add \
    binutils ca-certificates coreutils curl fping git graphviz imagemagick mtr mysql-client net-snmp net-snmp-tools \
    nginx nmap openssl python2 rrdtool runit shadow ssmtp supervisor tzdata util-linux whois \
